...
class AutoencoderVA(nn.Module):
    """Vision Foundation Model Aligned VAE Implementation"""
        
    
    def __init__(self, cfg: AutoencoderVACfg, img_size=256, horizon_flip=0.5, fp16=True):
        """Initialize VA_VAE
        Args:
    ...
    def encode(self, images):
        ...
        """
        with torch.no_grad():
            return self.model.encode(images.cuda())
...
#     vae = VA_VAE('./configs/vavae_f16d32_vfdinov2.yaml')
#     vae.load()