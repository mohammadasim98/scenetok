...
echo 'python -m src.scripts.preprocess_dataset dataset=videodc_re10k dataset.data_root='"${root}"' stage='"${stage}"' output_dir='"${output_dir}"' flip='"${flip}"' index="${SLURM_ARRAY_TASK_ID}" size='"${size}">> $jobscript
